...
@section('title')
    Upload Bill Of Material (BOM) Semi Finish Good
@endsection
...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">Upload Bill Of Material (BOM) Semi Finish Good</h4>
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('bom_semi.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Create BOM Semi Finish Good</a>
        </div><!-- end col -->
        <div class="col-xs-12 text-right">
            ...
            <a href="{{ route('bom_semi.export') }}" class="btn btn-custom btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-download"></i> Eksport</a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-bom_semi">
                    <thead>
                        <tr>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('bom_semi.import') }}" method="post" enctype="multipart/form-data" id="form-import">
                            @csrf
