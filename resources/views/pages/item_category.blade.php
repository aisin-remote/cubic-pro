...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('item_category.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Create Item Category</a>
        </div><!-- end col -->
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-item_category">
                    <thead>
                        <tr>
                            <th>Category Code</th>
                            <th>Category Name</th>
...
<script src="{{ url('assets/js/pages/item_category.js') }}"></script>
@endpush