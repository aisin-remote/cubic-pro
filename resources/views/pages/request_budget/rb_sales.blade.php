        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="page-title-box">
                    <h4 class="page-title">Upload Request Budget Sales</h4>
                    <ol class="breadcrumb p-0 m-0">
                        <li><a href="{{ route('masterprice.index') }}">Upload Request Budget Sales</a></li>
                        <li class="active">
                            Upload Request Budget Sales
                        </li>
                    </ol>
                        ...
                        <form action="{{ route('sales.import') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <a href="{{ url('files\Template_Sales_New_2025_New.xlsx') }}"><i
                                            class="mdi mdi-download"></i> Format RB Sales&emsp;</a>
                                </div>
                                <!-- <div class="form-group">
                                    <label>
