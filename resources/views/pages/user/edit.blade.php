                ...
                <form action="{{ route('user.update', $user->id) }}" method="post" id="form-add-edit">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="select2" data-placeholder="Status" data-allow-clear="true">
                                ...
                                @foreach ($status as $status)
                                    <option value="{{ $status['id'] }}"{{ $status['id'] == $user->status ? 'selected=selected' : '' }}>{{ $status['text'] }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="sap_cc_code" placeholder="SAP CC Code" class="form-control" value="{{ $user->sap_cc_code }}">
                        </div>
