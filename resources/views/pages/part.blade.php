...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">Master Part</h4>
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('part.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Create Part</a>
        </div><!-- end col -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-part">
                    <thead>
                        <tr>
                            <th>Part Number</th>
                            <th>Part name</th>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ route('part.import') }}" method="post" enctype="multipart/form-data" id="form-import">
                            @csrf
...
<script src="{{ url('assets/js/pages/part.js') }}"></script>
@endpush