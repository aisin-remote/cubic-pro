...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-list-approval-capex">
                    <thead>
                        <tr>
                            <th>Department</th>
...
<script src="{{ url('assets/js/pages/list-approval-capex-unvalidated.js') }}"></script>
