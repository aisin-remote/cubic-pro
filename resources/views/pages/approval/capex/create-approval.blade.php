...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('approval-capex.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Create Capex Approval Sheet</a>
        </div><!-- end col -->
    </div>
