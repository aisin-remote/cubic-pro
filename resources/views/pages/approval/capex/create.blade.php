                            ...
                            <div class="form-group">
                                ...
                                <select name="remarks" class="select2" data-tags="true" data-placeholder="Item Detail">
                                    ...
                                    @else
                                        ...
                                        <option value="{{ $cart->item->item_descriptions }}" total="{{$cart->total}}" item_id="{{$cart->item_id}}" item_spec="{{$cart->item->item_spesification}}" actual_qty="{{$cart->qty}}" uom_id="{{$cart->item->uom_id}}">{{ $cart->item->item_description }}</option>
                                        @endforeach
