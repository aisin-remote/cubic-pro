...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('help.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Tambah Bantuan</a>
        </div><!-- end col -->
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-help">
                    <thead>
                        <tr>
...
<script src="{{ url('assets/js/pages/help.js') }}"></script>
@endpush