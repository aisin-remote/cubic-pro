...
class DmaterialRb extends Model
{
	...
	protected static function getMaterialElektrikDetail($payload=[]){
		$materialelectrik = DmaterialRb::select(
            ...
            ->groupBy('acc_code')
            ->get();
		return $materialelectrik;
	}

	protected static function getMaterialUnitDetail($payload=[]){
	...
	protected static function getMaterialBodyDetail($payload=[]){
	...
	// bydept
	protected static function getMaterialElektrikDept($payload=[]){
		$materialelectrik = DmaterialRb::select(
            'dept',
            'acc_name',
            'acc_code',
	...
	protected static function getMaterialUnitDept($payload=[]){
		$materialunit = DmaterialRb::select(
            'dept',
            'acc_name',
            'acc_code',
	...
	protected static function getMaterialBodyDept($payload=[]){
		$materialbody = DmaterialRb::select(
            'dept',
            'acc_name',
            'acc_code',
