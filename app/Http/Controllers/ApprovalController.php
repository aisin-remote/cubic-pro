...
class ApprovalController extends Controller
{
    ...
    public static function sumBudgetGroupPlan(
        $budget_type,
        $group_type,
        $group_name,
        $thousands = 1000000,
    ...
    public static function sumBudgetGroupActual(
        $budget_type,
        $group_type,
        $group_name,
    ...
    public static function sumBudgetPlan(
        $budget_type,
        $plan_code,
        $group_name = [],
        $group_type = 'division',
    ...
    public static function sumBudgetPlanMonthly(
        $budget_type,
        $filter_date,
        $plan_code,
        $group_name = [],
    ...
    public static function sumBudgetActualMonthly(
        $budget_type,
        $filter_date,
        $group_name = [],
        $group_type = 'division',
