...
class CreateLaborRequestBudgetsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('labor_request_budgets', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('labor_request_budgets');
    }
}
